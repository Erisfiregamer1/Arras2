...
// Define player keys
var keys = ["k", "l", "testk", "ErisCodingTest",
          ...
          case "0":
            {
              ...
              // cheatingbois
              if (player.body != null) {
                if (socket.key === "ErisCodingTest" || socket.key === "trustedlogin947239730428592735973457309457trustedlogin") {
      ...
      const broadcast = (() => {
        ...
        const getminimap = (() => {
          ...
          let cleanmapreader = (() => {
            ...
            // Define the function
            return room.gameMode === "ffa" ? // ffa function builder
            (() => {
              // Make flatteners
