...
exports.deepClone = (obj, hash = new WeakMap()) => {
    ...
    if (obj instanceof Map) Array.from(obj, ([key, val]) => result.set(exports.deepClone(key, hash), exports.deepClone(val, hash)));else if (obj instanceof Set) Array.from(obj, key => result.add(exports.deepClone(key, hash)));
    // Register in hash    
    hash.set(obj, result);
